...
public class SynTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syn_timer);
    ...
    private void startTimer() {
        if (!timerRunning) {
            ...
            if (!intervalString.isEmpty()) {
                ...
                Toast.makeText(SynTimer.this, "Please enter a valid time interval.", Toast.LENGTH_SHORT).show();
            }
        } else {
            stopTimer();
        }
    ...
    private void showAlertDialog() {
        playAlarm();
        AlertDialog.Builder builder = new AlertDialog.Builder(SynTimer.this);
        ...
        builder.setPositiveButton("Snooze", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                stopTimer();
                Toast.makeText(SynTimer.this, "Snooze clicked", Toast.LENGTH_SHORT).show();
                stopAlarm();
            }
        });
        builder.setNegativeButton("Say you are OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                stopTimer();
                Toast.makeText(SynTimer.this, "Send SMS clicked", Toast.LENGTH_SHORT).show();
                sendSMSOK();
                stopAlarm();
            }
        });
    ...
    private void getCurrentLocationAndSendSMS() {
        ...
        if (!phoneNumber.isEmpty()) {
            if (ContextCompat.checkSelfPermission(SynTimer.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(SynTimer.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, MY_PERMISSIONS_REQUEST_SEND_SMS);
            } else {
                ...
                if (locationManager != null && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    if (location != null) {
                        ...
                        Toast.makeText(SynTimer.this, "Unable to retrieve location.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(SynTimer.this, "GPS is disabled.", Toast.LENGTH_SHORT).show();
                }
            }
        } else {
            Toast.makeText(SynTimer.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void sendSMS(String phoneNumber, String message) {
        ...
        Toast.makeText(SynTimer.this, "SMS Sent", Toast.LENGTH_SHORT).show();
    }
    private void sendSMSOK() {
        String phoneNumber = etPhoneNumber.getText().toString().trim();
        SmsManager smsManager = SmsManager.getDefault();
        smsManager.sendTextMessage(phoneNumber, null, " and I am OK", null, null);
        Toast.makeText(SynTimer.this, "SMS Sent", Toast.LENGTH_SHORT).show();
    }

    private String getLocationText(double latitude, double longitude) {
        Geocoder geocoder = new Geocoder(SynTimer.this, Locale.getDefault());
        try {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_SEND_SMS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(SynTimer.this, "Permission denied.", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
